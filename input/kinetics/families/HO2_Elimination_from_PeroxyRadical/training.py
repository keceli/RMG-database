...
""",
    history = [
        ("Tue Oct 15 11:52:02 2013","Shamel Merchant <shamel@mit.edu>","action","""New entry. Updated rate rule for CCCC(O[O])O = CCCC=O + HO2"""),
    ],
)
...
""",
    history = [
        ("Tue Oct 15 11:58:59 2013","Shamel Merchant <shamel@mit.edu>","action","""New entry. Updated rate rule for CCCC(O[O])O = CCC=CO + HO2"""),
    ],
)
